...
- apply the admission test in [`docs/architecture/decisions/README.md`](../docs/architecture/decisions/README.md); a reviewed architectural change updates or removes the affected current decision and reconciles its specification and consumer consequences in the same change, with Git history as the record of what it replaced;
