...
> **Relationship to other docs:** This plan complements `docs/testing-strategy.md` and `TESTING.md` (testing focus). Security-relevant testing items are referenced but not duplicated.
