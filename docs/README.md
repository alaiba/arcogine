...
| [ADR-0004: Model identity, revisions, and change management](architecture/decisions/0004-model-identity-revisions-and-change-management.md) | Accepted decision separating semantic model fingerprint from controlled revision/change-management identity, with external change-management systems (e.g. Jira) referenced, not depended on |
