...
| [Factory-design game consumer initiative](planning/factory-design-game-consumer.md) | Downstream game vertical slice that depends on the engine-readiness model-seam entry gate and engine-readiness Gates 1–5 |
