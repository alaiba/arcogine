...
| [ADR-0013: Execution context identity](architecture/decisions/0013-execution-context-identity.md) | Proposed O1 decision separating consequence classification from concrete operational-context identity, with opaque UUIDv4 identity, permanent kind binding, explicit establishment, and no O1 context registry |
...
| [Factory-design game challenge readiness](planning/factory-design-game-challenge-readiness.md) | Game-owned parallel track for challenge identity/validation, candidate admissibility, catalogue and budget rules, deterministic candidate evaluation, and attempt provenance/design-to-design comparison, with explicit cross-track boundaries |
