...
The [Factory publication identity contract](factory-design.md#11-publication-identity-and-provenance), [Factory Model v1 specification](factory-model-v1.md), and the [controlled revision contract](controlled-revisions.md) establish two identities that governance must not collapse:
