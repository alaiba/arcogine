...
This document is strictly current-state: every endpoint below exists in the codebase today. It is not a preview of Arcogine's eventual platform API — see [`PRODUCT_CHARTER.md`](/docs/product/charter.md) for the product direction this simulation API is one early step toward.
