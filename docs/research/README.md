...
| What independently continuing operational history, if any, needs durable identity, and what equality/continuity/fork rules define it? | Operational / Digital Twin | **Critical-path** | **ACTIVE** | [Operational boundary research](operational-execution-digital-twin-boundaries.md), [Operational identity independent adversarial review](operational-identity-adversarial-review.md), and ADR-0013 | Revised ADR/architecture, then the first narrow Operational implementation slice | 2026-09-09 |
