...
1. `initialize`
   - `clientInfo.name`: `codex-rate-limits-plugin`
...
- `account/rateLimits/read` error: treat the environment as unsupported for ChatGPT subscription rate limits and do not guess values.
