...
/**
 * The authored plant-scope floor extent of a {@code factory-model:v2} spatial record, in integer
 * cells.
 *
 * <p>This is an authored Factory fact under docs/architecture/factory-model-v2.md -- it is not
 * Engine policy, runtime state, transfer state, or animation/presentation geometry. Range validity
