 ...
 * reference cell, in a {@code factory-model:v2} spatial record.
 *
 ...
 * docs/architecture/factory-model-v2.md. Range validity ({@code width >= 1}, {@code height >= 1})
 * is deliberately not enforced by this constructor; see {@link FactoryModelV2Validator}.
 */
